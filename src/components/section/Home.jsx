    ...
    >
      <div className=" text-center z-10 px-4">
        ...
        <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
          ...
          applications. My goal is to build soluction that offer both
          exceptional performance and a delightful user experience
        </p>
        <div className="flex justify-center space-x-4">
          <a
            href="#project"
            className="bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,346,0.4)]"
          >
            View Project
          </a>
